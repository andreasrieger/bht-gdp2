...
public class KonsoleMenueFirma {
	 ...
	 * 
	 * @param dieFirma Instance of object Firma
	 */
	public static void menue(Firma dieFirma) {
		System.out.println(" *********************************************************");
		System.out.println("       Willkommen und viel Spass mit " + dieFirma.getName());
		System.out.println("                     Ihre FinanzSoft AG               ");
		System.out.println(" *********************************************************\n");
		...
		do {
			...
			System.out.println(" 2: Einen Angestellten / eine Angestellte eingeben");
			System.out.println(" 3: Die monatlichen Gehaltskosten ausgeben");
			System.out.println(" 4: Die Adresse aller Angehoerigen der Firma ausgeben");
			...
			case 2:
				...
				break;
			case 3:
				System.out.println("Monatliche Gehaltskosten: " + dieFirma.alleGehaelter());
				break;
			case 4:
	...
	/**
	 * Die Methode allesEinlesenUndSpeichern() dient zum Einlesen von Personendaten
	 * an der Konsole und zum Hinzufuegen einer Person in die Firma.
	 * 
	...
	private static void allesEinlesenUndSpeichern(int antwort, Firma dieFirma) {
		...
		if (antwort == 1) {
			Kunde k = new Kunde(nachname, vorname, strasse, hausnummer, ort, plz, weiblich);
			dieFirma.addKunde(k);
			// sonst - Angestellten anlegen
		} else {
			float gehalt = Konsole.getInputFloat(" Hoehe des Bruttogehalts: ");
			Angestellte ang = new Angestellte(nachname, vorname, strasse, hausnummer, ort, plz,
					weiblich, gehalt);
